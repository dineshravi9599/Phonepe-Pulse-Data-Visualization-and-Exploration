...
icon = Image.open(r"C:\Users\DINESH RAVI\Desktop\Project 2\logo.png")
st.set_page_config(page_title="Phonepe Pulse Data Visualization | By Dinesh Ravi",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This dashboard app is created by *Dinesh Ravi*!
...
if selected == "Top Charts":
    ...
    if Type == "Users":
        ...
        with col2:
            st.markdown("### :violet[District]")
            mycursor.execute(
                f"select District, sum(Registered_user) as Total_Users from map_user where year = {Year} and quarter = {Quarter} group by district order by Total_Users desc limit 10")
...
if selected == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'C:\Users\DINESH RAVI\PycharmProjects\phonepe\Statenames.csv')
            df1.State = df2
...
if selected == "About":
    ...
    st.write("##### https://github.com/dineshravi9599/Phonepe-Pulse-Data-Visualization-and-Exploration/tree/mainE")
